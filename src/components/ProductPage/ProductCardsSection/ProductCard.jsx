...
import football from './PoductCardsAssets/football-1.webp'
    ...
    return (
        ...
        <div className={styles.productCard}>
            <div className={styles.productImageSec}>
                ...
                <img src={props.productImage} className={styles.product} alt=" product image" />
            </div>
            <div className={styles.productDetailsSec}>
                ...
                <div className={styles.priceDetails}>
                    <div className={styles.discountDet}>
                        <img src={downArrow} className={styles.discountArrow} alt=" discount arrow" />
            ...
            <div>
                ...
                <div className={styles.ratingSection}>
                    ...
                    <img src={FlipAssured} className={styles.assuredLogo} alt="asssured logo" />
                </div>
            </div>
        </div>
        </>
